...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        def pepitaProfile = new UserProfile(userName:"pepita",name:"pepita", surname: "Swallow", mail: "pepita@gmail.com", birthDate: new Date(2018, 06, 22),userID: pepitaUser.getId() ,work:"devop",git:"www.git.com/pepita", linkedin:"wwww.linkedin.com/pepita", career: "tpi", approvedSubjects:["Intro","Orga"] ).save()
        def ivanProfile = new UserProfile(userName:"ivan",name:"Ivan", surname: "D", mail: "ivan@gmail.com", birthDate: new Date(2018, 06, 22), userID: ivanUser.getId() ,work:"devop",git:"www.git.com/pepita", linkedin:"wwww.linkedin.com/pepita", career: "tpi", approvedSubjects:["Intro","Orga"]).save()
        def nahuProfile = new UserProfile(userName:"nahu",name:"Nahu", surname: "A", mail: "nahu@gmail.com", birthDate: new Date(2018, 06, 22), userID: nahuUser.getId() ,work:"devop",git:"www.git.com/pepita", linkedin:"wwww.linkedin.com/pepita", career: "tpi", approvedSubjects:["Intro","Orga"]).save()
        def gabiProfile = new UserProfile(userName:"gabi",name:"Gabi", surname: "P", mail: "gabi@gmail.com", birthDate: new Date(2018, 06, 22), userID:  gabiUser.getId() ,work:"devop",git:"www.git.com/pepita", linkedin:"wwww.linkedin.com/pepita", career: "tpi", approvedSubjects:["Intro","Orga"]).save()
        def victorProfile = new UserProfile(userName:"victor",name:"Victor", surname: "D", mail: "victor@gmail.com", birthDate: new Date(2018, 06, 22), userID: victorUser.getId() ,work:"devop",git:"www.git.com/pepita", linkedin:"wwww.linkedin.com/pepita", career: "tpi", approvedSubjects:["Intro","Orga"]).save()
        def diegoProfile = new UserProfile(userName:"diego",name:"Diego", surname: "Diego", mail: "diego@gmail.com", birthDate: new Date(2018, 06, 22), userID: diegoUser.getId() ,work:"devop",git:"www.git.com/pepita", linkedin:"wwww.linkedin.com/pepita", career: "tpi", approvedSubjects:["Intro","Orga"]).save()
        def pabloProfile = new UserProfile(userName:"pablo",name:"Pablo", surname: "Suarez", mail: "pablo@gmail.com", birthDate: new Date(2018, 06, 22), userID: pabloUser.getId() ,work:"devop",git:"www.git.com/pepita", linkedin:"wwww.linkedin.com/pepita", career: "tpi", approvedSubjects:["Intro","Orga"]).save()
        def camiProfile = new UserProfile(userName:"cami",name:"Cami", surname: "Cintioli", mail: "cami@gmail.com", birthDate: new Date(2018, 06, 22), userID: camiUser.getId() ,work:"devop",git:"www.git.com/pepita", linkedin:"wwww.linkedin.com/pepita", career: "tpi", approvedSubjects:["Intro","Orga"]).save()
